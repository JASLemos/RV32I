...
#
# Script generated by Vivado on Mon Oct 28 17:02:28 -0300 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot testbench xil_defaultlib.testbench xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_8 dist_mem_gen_v8_0_15)
